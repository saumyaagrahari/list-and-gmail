# Chihper wheel with a function for finding an element in a list 

# find_in_list function defined here but not called 

# this function is used to find the position of the "query" in the "mainlist".is in the list then it returns its position, otherwise it returns None
...
# this function takes "plain_msg" as an argument and print/return the encrypted message. The "plain_msg" 
is tranfered into "encrypted_msg" using "shifted_chars" list. Example, if plain_msg = "ng" then n => p,g => i and hence encrypted_msg = "pi"
...
for character in encrypt_message:
    ...
    if character in encrypt_message:
    ...
    # this function takes "encrypted_msg" as an argument and print/return the encrypetd message. The "encrypted_msg" is tranfered into "decrypted_msg" using "shifted_chars" list. Example, if encrypted_msg = "pi" then p => n, i => g and hence decrypted_msg = "ng"

        decrypted_msg = " "

        for character in decryted_msg:
